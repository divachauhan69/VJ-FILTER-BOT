...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://rizmohd532:<db_password>@cluster0.xrcco1x.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
